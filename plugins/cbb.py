...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ ᴏᴡɴᴇʀ : <a href='tg://user?id={OWNER_ID}'>@Rcbkafan</a>\ᴍʏ ᴄᴏᴍᴍᴜɴɪᴛʏ : <a href='https://t.me/anime_bash_offical'>ᴀɴɪᴍᴇ ᴄʜᴀᴛ: <a href='https://t.me/anime_bash_chat'>ANIME ZONE</a></b>",
            disable_web_page_preview = True,
            reply_markup = InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton("⚡️ ᴄʟᴏsᴇ", callback_data = "close"),
                    InlineKeyboardButton('🍁 ᴘʀᴇᴍɪᴜᴍ', url='https://t.me/anime_bash_offical')
                    ]
                ]
            )
        )
